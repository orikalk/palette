...
Every [release](https://github.com/orikalk/palette/releases/latest) ships `orikalk.zip` and `orikalk.tar.gz` with one folder per format. For now that is `gimp/`, a palette per theme and mode (`orikalk-<theme>-<mode>.gpl`) for Aseprite, GIMP, Inkscape and Krita.
...
- [Blue Turtle](https://www.blueturtle-design.com/)
